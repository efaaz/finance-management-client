...
export function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      className: "col-span-1 lg:col-span-3 border-b-0 lg:border-none",
    },
  ];
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      <div className="sm:px-8 px-6 sm:border-none border-b border-neutral-800">
...
const FeatureTitle = ({ children }) => {
  return (
    <p className=" max-w-5xl mx-auto md:text-left tracking-tight text-black dark:text-white text-xl text-center md:text-2xl md:leading-snug">
      {children}
    </p>
  );
};
...
const FeatureDescription = ({ children }) => {
  return (
    <p
      className={cn(
        "text-sm md:text-base max-w-4xl md:text-left mx-auto",
        "text-neutral-500 text-center font-normal dark:text-neutral-300",
        "md:text-left text-center md:mx-0 mx-auto max-w-sm md:text-sm my-2"
      )}
    >
      {children}
    </p>
...
export const SkeletonOne = () => {
  return (
    <div className="relative sm:border-none flex py-8 px-2 gap-10 ">
      <div className="w-full p-5  mx-auto bg-white dark:bg-neutral-900 shadow-2xl group">
        <div className="flex flex-1 w-full h-full flex-col space-y-2  ">
          {/* TODO */}
          <img
            src="https://images.klipfolio.com/website/public/36ab37e3-6007-4918-9c3d-778105fe65d0/executive%20dashboard%20example.png"
            alt="header"
            width={400}
            height={400}
